...
const SalwarList = ({ products = [], category }) => {
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", }}>
        {filtered.map(item => (
          <div key={item.id} style={{ width: "200px", textAlign: "center", border: "1px solid #ddd", padding: "10px", borderRadius: "8px", marginTop:"20px" }}>
            <img
              src={item.image}
              alt={item.title}
